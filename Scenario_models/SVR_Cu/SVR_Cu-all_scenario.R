...
KhavrSVR_Micro_modeltune_Cu_expert <- tune(svm, Cu ~ b2_reflectance + b5_reflectance  + ci_mean_kh +  
...
KhavrSVR_Micro_modeltune_Cu_expert
plot(KhavrSVR_Micro_modeltune_Cu_expert)
...
plot(KhavrSVR_Micro_Cu_expert)
par(mfrow = c(2,1))
# Internal validation
KhavrSVR_Micro_Cu_expert_Internal <- predict(KhavrSVR_Micro_Cu_expert, newdata = RF_Micro_Scenario_models_dataset[Training_RF_Micro_scenario, ])
KhavrSVR_Micro_Cu_expert_Internal
goof(observed = RF_Micro_Scenario_models_dataset$Cu[Training_RF_Micro_scenario], predicted = KhavrSVR_Micro_Cu_expert_Internal ,  plot.it = TRUE)
# externalvalidation
KhavrSVR_Micro_Cu_expert_External <- predict(KhavrSVR_Micro_Cu_expert, newdata = RF_Micro_Scenario_models_dataset[-Training_RF_Micro_scenario, ])

goof(observed =  RF_Micro_Scenario_models_dataset$Cu[-Training_RF_Micro_scenario], predicted = KhavrSVR_Micro_Cu_expert_External,  plot.it = TRUE)
#training
nrmse(KhavrSVR_Micro_Cu_expert_Internal, RF_Micro_Scenario_models_dataset$Cu[Training_RF_Micro_scenario])
MAPE(KhavrSVR_Micro_Cu_expert_Internal, RF_Micro_Scenario_models_dataset$Cu[Training_RF_Micro_scenario])

##testing
nrmse(KhavrSVR_Micro_Cu_expert_External, RF_Micro_Scenario_models_dataset$Cu[-Training_RF_Micro_scenario])
MAPE(KhavrSVR_Micro_Cu_expert_External, RF_Micro_Scenario_models_dataset$Cu[-Training_RF_Micro_scenario])
