...
library(e1071)
###Landsat
KhavrSVR_Micro_modeltune_Zn_RS_Landsat <- tune(svm, Zn ~ b2_reflectance + b3_reflectance + b4_reflectance + b5_reflectance + b6_reflectance + 
...
KhavrSVR_Micro_modeltune_Zn_RS_Landsat


KhavrSVR_Micro_Zn_RS_Landsat <- svm(Zn ~ b2_reflectance + b3_reflectance + b4_reflectance + b5_reflectance + b6_reflectance + b7_reflectance + 
...
KhavrSVR_Micro_modeltune_Zn_expert <- tune(svm, Zn ~ b2_reflectance + b5_reflectance  + ci_mean_kh +  
...
KhavrSVR_Micro_modeltune_Zn_expert
plot(KhavrSVR_Micro_modeltune_Zn_expert)
...
par(mfrow = c(2,1))
# Internal validation
KhavrSVR_Micro_Zn_expert_Internal <- predict(KhavrSVR_Micro_Zn_expert, newdata = RF_Micro_Scenario_models_dataset[Training_RF_Micro_scenario, ])
KhavrSVR_Micro_Zn_expert_Internal
goof(observed = RF_Micro_Scenario_models_dataset$Zn[Training_RF_Micro_scenario], predicted = KhavrSVR_Micro_Zn_expert_Internal ,  plot.it = TRUE)
# externalvalidation
KhavrSVR_Micro_Zn_expert_External <- predict(KhavrSVR_Micro_Zn_expert, newdata = RF_Micro_Scenario_models_dataset[-Training_RF_Micro_scenario, ])

goof(observed =  RF_Micro_Scenario_models_dataset$Zn[-Training_RF_Micro_scenario], predicted = KhavrSVR_Micro_Zn_expert_External,  plot.it = TRUE)
#training
nrmse(KhavrSVR_Micro_Zn_expert_Internal, RF_Micro_Scenario_models_dataset$Zn[Training_RF_Micro_scenario])
MAPE(KhavrSVR_Micro_Zn_expert_Internal, RF_Micro_Scenario_models_dataset$Zn[Training_RF_Micro_scenario])

##testing
nrmse(KhavrSVR_Micro_Zn_expert_External, RF_Micro_Scenario_models_dataset$Zn[-Training_RF_Micro_scenario])
MAPE(KhavrSVR_Micro_Zn_expert_External, RF_Micro_Scenario_models_dataset$Zn[-Training_RF_Micro_scenario])
